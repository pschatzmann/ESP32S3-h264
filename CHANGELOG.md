...
### Features
- Added hardware encoder support for multiple pixel formats on supported hardware (>=3.0.0):
  - BGR888 (24-bit RGB format)
  - RGB565_LE (16-bit RGB Little-Endian format)
...
- Fixed compatibility issue by temporarily disabling HWLP in the decoder for affected hardware
